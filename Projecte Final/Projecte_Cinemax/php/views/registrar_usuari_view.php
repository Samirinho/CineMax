...
<body>
    <header class="capcalera">
        <img src="../imatges/logoBln.png" class="logo" alt="logo"></a>
        <nav class="opcions">
            <ul class="menu">
                <li><a href="../php/index.php">Login</a></li>
                <li><a href="../php/registre_usuari.php">Registre</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main>
        ...
        <form class="formulari" action="../php/verificacio_registre.php" method="post">
            ...
            <div class="contenidor text">
                <h2 class="titolform">Registra't</h2>
                <p class="intro">Crear nou compte a CineMax</p>
            </div>
            ...
            <div class="contenidor registre">
                ...
                <p class="camp">
                    <label for="nom" class="lletres">Email</label>
                    <input class="camp" type="text" name="email" placeholder="Usuari">
                </p>
